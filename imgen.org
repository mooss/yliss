...
tangle/imgen.cpp:409:9: warning: ‘gl_context::height_’ will be initialized after [-Wreorder]
  409 |     int height_;
      |         ^~~~~~~
tangle/imgen.cpp:377:26: warning:   ‘std::vector<unsigned char> gl_context::buffer’ [-Wreorder]
  377 |     std::vector<GLubyte> buffer;
      |                          ^~~~~~
tangle/imgen.cpp:378:5: warning:   when initialized here [-Wreorder]
  378 |     gl_context(int width, int height):
      |     ^~~~~~~~~~
