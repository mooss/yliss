...
# TODO: Verify the above with other source, I don't think I understood everything I needed.

Those matrices are abstracted away in =movipr= (=mvp= was too short and =model_view_projection= was too long):
# TODO: This struct is a bit long and shoud be cut in half and a bit more explanations should be provided.
#+name: movipr
#+begin_src cpp
struct movipr {
