...
#+end_src
#+depends:colorful-example :noweb lazy_window shader_program VAO vec_vertices indexes
...
class orbital_camera: public camera {
  public:
    orbital_camera(
        ...
        focal_point_(std::move(focal_point)), radius_(radius),
        longitude_(longitude), latitude_(latitude),
        camera({0, 0, 0}, {0, 0, 0}, std::move(up))
    {refresh();}
