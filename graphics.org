...
The documentation of both [[http://docs.gl/gl3/glDeleteBuffers][=glDeleteBuffers=]] and [[http://docs.gl/gl3/glDeleteVertexArrays][=glDeleteVertexArrays]] state that deleting objects whose name is 0 does nothing and that calling those function on a defined name reverts said name to 0.
...
The deleting logic was adapted from =opengl_buffer=.
