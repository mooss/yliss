...
In my (rather uninformed) opinion, it behaves as some kind of weird distance between $i$ and $2^d$, in that it is inversely proportional to the number of times the index can be divided by 2, with a maximum number of division of $d$.
