...
For now, this is mostly a literate programing OpenGL sandbox (see [[file:geometric_primitives.org]], [[file:window.org]]) and a pretty logo generator (see [[file:octasierp.org]] and the picture below).
